class PigLatin:
    ...
    - Se contiver 'qu' após consoantes iniciais, move 'qu' e o que vem antes para o final e adiciona 'ay'.
    - Caso contrário, move o grupo de consoantes iniciais até a primeira vogal (ou 'y', exceto se for inicial)
